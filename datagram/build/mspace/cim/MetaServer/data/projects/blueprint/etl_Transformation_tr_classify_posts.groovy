...
def entity = session.createQuery("from etl.Transformation where name = :name").setParameter("name", "tr_classify_posts").uniqueResult() 
...
entity.targets.find {it.name == "CSV_3"}.context = null
